...
if $dateext {
  ...
  #switched from broken case statements to if
...
#  case $missingok {
#    undef: { notify{"missingok was undefined":}}
#    'true': { notify{"missingok was true":}
#		$sane_missingok = 'missingok' }
#    'false' : { notify{"missingok was true":}
#		$sane_missingok = 'nomissingok' }
#    default: {
#      #fail("Logrotate::Rule[${name}]: missingok must be a boolean ${missingok} ${sane_missingok}")
#      notify("Logrotate::Rule[${name}]: missingok must be a boolean ${missingok} ${sane_missingok}")
#    }
#  }
